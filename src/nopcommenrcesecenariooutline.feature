Feature: Bookcategory
  ...
  Background: I should be able to see homepage
    Given I enter URL"https://demo.nopocommerce.com/"
    And I am on homepage

  Scenario Outline: I should be able to see top menu tabs on homepage with categories
    When I am on home pge
  ...
  Scenario Outline: I should be abel to see book page with filters
    When I select book category from top menu tabs on home page
    Then I should be navigated to book category
    And I should be abel to see"<filters>"
    Examples:
      | filters  |
      | Short by |
      | Display  |
  ...
  Scenario Outline: I should be able to choose any filter option with specific result
    ...
    Then I should be able to se "<list>" in dropdown menu
    Examples:
      | filter  | list                                                                          |
