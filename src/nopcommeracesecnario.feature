Feature: Demo Nopcommerce's top menu acceptance criteria
  As a user,I would like to check acceptance criteria top menu
  ...
  Scenario: Verify that user can see 'Name: A to Z' is selection in 'Sort by' filter
    Given User is on Books Category page
    When User is on Books Category page
  ...
  Scenario: Verify that user can see 'Name: A to Z' is first option in 'Sort by' filter
    ...
    When User is on Books Category page
    And Click on 'Sort by' Filter
    And Check that 'Name: A to Z' is first in present
    Then 'Name: A to Z' selection is first option in order

  Scenario: Verify that user can see 'Name: A to Z' filter us functioning as expected(Note: Prodcuts are filtered in alphabetical order)
    Given User is on Books Category page
    When User is on Books Category page
    And Click on 'Sort by' Filter
